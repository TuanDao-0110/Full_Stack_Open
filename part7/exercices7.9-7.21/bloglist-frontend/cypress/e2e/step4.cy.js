...
describe('when logged in and create new blog and add like', () => {
  beforeEach(() => {
  ...
  it('new blogs can be created and delete', () => {
    ...
    // open view button
    cy.contains('new test title by author')
      .parent()
      .find('button')
      .should('contain', 'view')
      .as('theButton');
    ...
    cy.contains('likes: 0').find('button').should('contain', 'like').as('theLike');
